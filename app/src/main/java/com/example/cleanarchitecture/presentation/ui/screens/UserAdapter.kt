...
class UserAdapter : RecyclerView.Adapter<UserAdapter.ViewHolder>() {
    ...
    fun setData(newUserList: MutableList<User>) {
        // Diff the old and new snapshots first so RecyclerView can animate only the changed rows.
    ...
    class DiffToolUtil(
        ...
        override fun areContentsTheSame(
            ...
            // TODO: Compare the whole item once row content becomes editable or partially updatable.
            return oldList[oldItemPosition].id == newList[newItemPosition].id
        }
    }
}
